 ...
 * @author David
 */
public class Devolucion extends Comodin{
    public MouseAdapter mouseListener;
    public Devolucion(String nombre, String descripcion, Mesa mesa) {
    ...
    public void usarComodin(boolean isJugador, JLabel label){ 
        ...
        try{
            ...
            if(isJugador){
                System.out.println(mesa.jugador.getMano().size());
                if(mesa.jugador.getMano().size()==1){
                    JOptionPane.showMessageDialog(mesa.JDialogJuego, "No se puede devolver la carta oculta.", "USO INDEBIDO", JOptionPane.INFORMATION_MESSAGE);
                }else{
                    ...
                    System.out.println(mesa.cartasJugador[indice-1].getIcon());
                ...
                if(mesa.maquina.getMano().size()==1){
                    JOptionPane.showMessageDialog(mesa.JDialogJuego, "No se puede devolver la carta oculta.", "USO INDEBIDO", JOptionPane.INFORMATION_MESSAGE);//Esto no va a saltar nunca.
                }else{
